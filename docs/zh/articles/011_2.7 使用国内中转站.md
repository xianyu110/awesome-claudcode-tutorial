- ## **第一步：准备工作**
  ...
  **Windows 用户**：
  ...
  1. 点击开始菜单，搜索「PowerShell」，右键选择「以管理员身份运行」
  2. 复制这行命令，粘贴进去，回车：
  ...
  **安装完成的标志**：会提示「Claude Code installed successfully」。
  ...
  | 购买链接： https://maynorai.tqfk.xyz/cat/5                   |                                  |                                   |
  ...
  这个时候配置base url 和 api key 比较麻烦，可以用 cc [Switch] 去配置：

   cc Switch：https://github.com/farion1231/cc-switch 

  安装教程：https://github.com/farion1231/cc-switch/blob/main/README_ZH.md   
